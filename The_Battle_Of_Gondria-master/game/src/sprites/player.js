export default class Player {
  ...
  createHUD() {
    this.meio = this.scene.cameras.main.midPoint
    this.scene.hud_1 = this.scene.add.image(this.meio.x-282, 40, 'hud_principal');
    this.scene.hud_2 = this.scene.add.image(this.meio.x+362, 40, 'hud_tempo');
